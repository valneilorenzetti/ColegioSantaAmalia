...
?>
    <ul class="rslides">
        <?php
                wp_reset_query();
                query_posts('post_type=banner&showposts=-1&orderby=date&order=asc');
    ...
    <section class="endereco">
        <section class="row bl-end">
            <?php
                    ...
                    if(have_posts()) : while(have_posts()) : the_post();
            ?>
                        <h2><?php the_title(); ?> • <a href="tel:115070-3555">(11) 5070.3555</a></h2>
    ...
    <section id="cursos" class="row hide-for-small-only  cursos">
        <?php
//                echo do_shortcode('[popup_trigger id="1023" tag="festa-junina"]');
                wp_reset_query();
                query_posts('post_type=cursos&showposts=-1&orderby=date&order=asc');
                if(have_posts()) : while(have_posts()) : the_post();
        ?>
                    <section class="large-3 medium-3 columns bl_cursos">
    ...
    <section class="diferenciais">
        <section class="row">
            ...
            <h2><?php echo $obj->description; ?></h2>
            <?php
                    wp_reset_query();
    ...
    <section class="row noticias">
        <h2><a href="<?php bloginfo('url'); ?>/noticias"><i class="hide-for-small-only fa fa-laptop"></i>NOTÍCIAS</a></h2>
        <section class="large-7 columns">
            ...
            <a href="<?php bloginfo('url'); ?>/noticias" id="ver-not" class="hide-for-small-only link">VER TODAS</a>
        </section>
        <section class="large-5 columns shared">
            <div class="hide-for-small-only hide-for-medium-only fb-like-box" data-href="https://www.facebook.com/ColegioSantaAmalia?fref=ts&amp;rf=152528158211626" data-width="400" data-height="300" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="true"></div>
            <div class="share">
                <a class="hide-for-large-only fa" target="_blank" href="https://www.facebook.com/ColegioSantaAmalia"><i class="fa fa-facebook"></i></a>
